...
## Custom Shortcuts (toggle_app + oqo.py)
...
| `Super+j` | `oqo.py` | Oracle Quick Open |
| `Super+u` | `oqo.py --no-open` | OQO without opening |
| `Super+y` | `oqo.py --one-value` | OQO single value |
| `Super+o` | `oqo.py --raw-capture` | OQO raw capture |
